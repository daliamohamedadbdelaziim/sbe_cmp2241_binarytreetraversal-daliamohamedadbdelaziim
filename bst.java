...
//first print the root of T  and if numChildren(P)!=0 ,print children from each node,until the end of child   
...
//first print children from each node and print root 
